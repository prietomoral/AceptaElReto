...
public class Moviles {
    ...
    public static boolean esBalenceado(int pi, int di, int pd, int dd, int p) {
        ...
        if (pi == 0) {
            ...
            izda = esBalenceado(ipi, idi, ipd, idd, pi);
            pesoIzdo = ipi + ipd;
        }
        ...
        if (pd == 0) {
            ...
            dcha = esBalenceado(dpi, ddi, dpd, ddd, pd);
            pesoDcho = dpi + dpd;
        }
    ...
    public static void main(String[] args) {
        ...
        while (!(entrada[0].equals("0") && entrada[1].equals("0") && entrada[2].equals("0") && entrada[3].equals("0"))) {
            balancea = esBalenceado(Integer.parseInt(entrada[0]), Integer.parseInt(entrada[1]), Integer.parseInt(entrada[2]),
                    Integer.parseInt(entrada[3]), peso);
