	...
	public static void main(String[] args) {
		...
		for (int prueba = 0; prueba < numCasos; prueba++ ){
			...
			for (int i = 0; i < antenasDistanciaCobertura.length; i=i+2) {
				...
				if (!coberMin && Integer.valueOf(antenasDistanciaCobertura[0])-Integer.valueOf(antenasDistanciaCobertura[1])<=0) {
					coberMin=true;
					coberMax=Integer.valueOf(antenasDistanciaCobertura[0])+Integer.valueOf(antenasDistanciaCobertura[1]);
				}else {
					continue;	
				}
